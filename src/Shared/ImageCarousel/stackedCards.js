...
export default class stackedCards {
  ...
  init() {
    ...
    var ref = document.readyState;
    if (ref === "interactive" || ref === "complete") {
      console.log(this);
      me.draw();
    } else {
      document.addEventListener("DOMContentLoaded", me.draw);
    }
  }
  ...
  reCalculateTransformsOnClick(nextCnt, prevCnt) {
    var me = this;
  ...
  loopNodeList(els, callback, scope) {
